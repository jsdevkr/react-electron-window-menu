...
class PopupMenu extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "rewm-contextmenu", style: menuStyles, ref: this.popupMenuRef }, menuItems.map((item, i) => (React.createElement(MenuItem_1.default, { key: i, item: item, onClickItem: onClickItem, onHoverItem: this.onHoverItem })))));
    }
}
