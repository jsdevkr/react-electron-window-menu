...
var ContextMenu = /** @class */ (function () {
    ...
    Object.defineProperty(ContextMenu.prototype, "visible", {
        get: function () {
    ...
    ContextMenu.prototype.setMenu = function (menuItems) {
        this.menuItems = __spread(menuItems);
        this.render();
        return this;
    };
    ContextMenu.prototype.popup = function (popupOption) {
        ...
        var existContainer = document.querySelectorAll("[data-rewm-contextmenu-container=\"" + id + "\"]")[0];
    ...
    ContextMenu.prototype.render = function () {
        ...
        ReactDOM.render(React.createElement(components_1.PopupMenu, { menuItems: this.menuItems, onClickItem: this.onClickItem, visible: this.visible, parentOffset: {
