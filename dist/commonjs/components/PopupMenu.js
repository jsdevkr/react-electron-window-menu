...
var PopupMenu = /** @class */ (function (_super) {
    ...
    PopupMenu.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "rewm-contextmenu", style: menuStyles, ref: this.popupMenuRef }, menuItems.map(function (item, i) { return (React.createElement(MenuItem_1.default, { key: i, item: item, onClickItem: onClickItem, onHoverItem: _this.onHoverItem })); })));
    };
    return PopupMenu;
}(React.Component));
